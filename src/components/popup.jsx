...
import tshirtPopup from '../resources/images/tshirt.jpg';

import heartPopup from '../resources/Icons/heart.svg';
import popularityPopup from '../resources/Icons/popularity.png';
import votesPopup from '../resources/Icons/votes.png';
import calendarioPopup from '../resources/Icons/micalendarioblanco.png';
    ...
    <input type="checkbox" id="3" />
{
    ...
    <div className="modal">
      <div className="modal__inner">
        <div className="imagen-pelicula-popup">
          <img src={video.cover}/>
        </div>
        <div className="detalle-pelicula-popup">
          <div className="info-pelicula-popup">
            <div className="container-info-pelicula-popup">
              <div className="container-titulo-popup">
                <span className="titulo-popup">{video.title}</span>
              </div>
              <div className="container-genero-idioma">
                <span className="genero-popup">{video.genero}</span>
                <span className="idioma-popup">
                  EN
                </span>
              </div>
              <div className="container-rating-popularity-votes-popup">
                <div className="container-icon-popup">
                  <div className="rating-numero-popup">
                    <img className="tamaño-iconos" src={heartPopup}/>
                    <span className="numero-popup">{video.heart}</span>
                  </div>
                  <span className="nombre-icono-popup">Rating</span>
                </div>

                <div className="container-icon-popup">
                  <div className="popularity-numero-popup">
                    <img className="tamaño-iconos" src={popularityPopup}/>
                    <span className="numero-popup">{video.popularity}</span>
                  </div>
                  <span className="nombre-icono-popup">Popularity</span>
                </div>

                <div className="container-icon-popup">
                  <div className="votes-numero-popup">
                    <img className="tamaño-iconos" src={votesPopup}/>
                    <span className="numero-popup">{video.votos}</span>
                  </div>
                  <span className="nombre-icono-popup">Votes</span>
                </div>
              </div>
            </div>
            
          </div>
          <div className="sinopsis-pelicula-popup">
            <p >{video.sinopsis}</p>

            <label className="fecha-pelicula">
              
              <img  className="icono-fecha" src={calendarioPopup}/>
              
              <span className="fecha-popup">{video.fecha}</span>
        ...
        <label className="cerrar-modal" htmlFor="3"></label>
      </div>
    </div>
        )
